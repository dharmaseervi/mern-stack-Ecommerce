...
const DealsOfDay = () => {
    ...
    return (
        <section className="bg-slate-100 m-6 py-6 flex flex-col justify-between  items-center ">
                ...
                {deals.slice(10, 14).map((deal) => (
                    <div key={deal.id} className="bg-gray-100 rounded-lg shadow-md p-6 flex flex-col ">
                        <div className="aspect-w-3 aspect-h-4 mb-4">
                            <img src={deal?.photo?.[0]} alt={deal.productname} className="object-cover w-full h-full rounded" />
                        </div>
