...
export default function ProductOverview({ productListId }) {
    ...
    const { addToCart, ProductOverviewId } = useContext(CartContext);
    ...
    const colors = [
        { name: 'black titanium', class: 'bg-white', selectedClass: 'ring-gray-400' },
        { name: 'natural titanium', class: 'bg-white', selectedClass: 'ring-gray-400' },
        { name: 'white', class: 'bg-gray-200', selectedClass: 'ring-gray-400' },
        { name: 'blue', class: 'bg-gray-900', selectedClass: 'ring-gray-900' },
    ]
    const sizes = [
        { name: productData?.variants?.[1]?.value, inStock: true },
    ]
