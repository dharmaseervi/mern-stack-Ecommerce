...
export default function Header() {
  ...
  return (
    <div id="sticky-header" className="sticky top-0 z-10 bg-white">
      <div className="bg-white">
              ...
              <div className="fixed inset-0 z-40 flex">
                ...
                >
                  <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                    ...
                    {session ? (null) : (<div className="space-y-6 border-t border-gray-200 px-4 py-6">
        ...
        <header className="relative bg-white">
          <div className=" flex h-14 items-center justify-center bg-indigo-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
            ...
            {session ? (null) : (<div className="lg:hidden flex justify-end gap-5 w-full px-2 ">
              <div className="flow-root">
                <Link
                  href={"/signin"}
                  className="-m-2 block p-2 font-medium rounded hover:bg-white hover:text-black "
                >
                  Sign in
                </Link>
              </div>
