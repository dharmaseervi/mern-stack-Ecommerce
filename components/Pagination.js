...
export function CircularPagination({ totalPages, currentPage, paginate }) {
    ...
    return (
         <div className="fixed bottom-0 left-0 w-full bg-white py-4 px-6 flex justify-evenly items-center">
            ...
            <div className="flex items-center gap-2">
                {[...Array(Math.min(totalPages - startPage + 1, 10))].map((_, index) => (
