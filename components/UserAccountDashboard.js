    ...
    return (
        <div className='container mx-auto '>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
                ...
                {/* Shopping Section */}
                <Link href="/order" className='bg-gray-100 rounded-lg shadow-md p-8 text-center flex flex-col justify-center'>
                ...
                {/* Shipping Section */}
                <Link href="/address" className='bg-gray-100 rounded-lg shadow-md p-8 text-center flex flex-col justify-center'>
