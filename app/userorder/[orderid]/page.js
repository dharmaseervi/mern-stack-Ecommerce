  ...
  return (
    <div>
      <Layout>
        ...
        <div className="flex flex-col gap-6 p-4 sm:p-6 border rounded-md mb-5">
...

        {
          orderPlaced?.map((order, index) => (
            ...
            >
              ...
              <div className="flex justify-between  bg-slate-200 h-10 items-center p-2">
                <h1 className="text-xl text-black">Total</h1>
                <h1>₹{order?.amount?.toLocaleString('en-IN')}</h1>
              </div>
            </div>
          ))
        }
