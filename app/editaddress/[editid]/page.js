'use client'
import { GetAddressByid, UpdateAddress } from '@/lib/addressAction';
...
export default function Page({ params }) {
    ...
    useEffect(() => {
        const fetchAddressByid = async () => {
            ...
            setIsDefault(resJson.isDefault)
            console.log(resJson, 'red');
            setValue('isDefault', resJson.isDefault);
            setValue('name', resJson.name || '');
            setValue('pincode', resJson.pincode || '');
            setValue('address', resJson.address || '');
            setValue('town', resJson.town || '');
            setValue('city', resJson.city || '');
            setValue('state', resJson.state || '');
            setValue('mobileno', resJson.mobileno || '');
    ...
    return (
        <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8 border">
