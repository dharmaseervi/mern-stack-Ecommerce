                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                            ...
                            <div className="lg:col-span-3">
                                                ...
                                                <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                                                    {currentProducts.map((product) => (
                                                        ...
                                                        >
                                                            ...
                                                            <h3 className="mt-4 text-sm text-gray-700 overflow-hidden  whitespace-nowrap">
                                                                {product.productname}
                                                            </h3>
                                ...
                                <div className="flex justify-center my-4  items-center mx-auto max-w-2xl px-4 py-4 sm:px-6  rounded lg:max-w-7xl lg:px-8 ">
                                    <div className="flex justify-center my-4 items-center mx-auto max-w-2xl px-4 py-4 sm:px-6 rounded lg:max-w-7xl lg:px-8 ">
                                        {categoryData && (
                                            <CircularPagination totalPages={Math.ceil(categoryData.length / productsPerPage)} currentPage={currentPage} paginate={paginate} />
                                        )}
                                    </div>
